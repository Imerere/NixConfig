...

{
  programs.vesktop = {
    ...
    vencord = {
      settings = {
        enabledThemes = [ "system24.theme.css" ];
        autoUpdate = false;
  ...
  home.file.".config/vesktop/themes/system24.theme.css".text = ''
/**
 * @name system24
...
body {
    ...
    --top-bar-button-position: titlebar; /* off: default position, hide: hide buttons completely, serverlist: move inbox button to server list, titlebar: move inbox button to channel titlebar (will hi[...] */
